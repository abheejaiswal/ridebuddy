...
router.get("/user/withdraw_commission", AuthController.getwithdraw_commission);
router.get("/user/getBrandAndModel", AuthController.getBrandAndModel);
...
router.post('/user/getRideById', ApiController.getRideDetailsById);
router.post("/user/add_vehicle", ApiController.addVehicle);
router.post("/user/update_vehicle", ApiController.updateVehicle);
router.post("/user/delete_vehicle", ApiController.deleteVehicle);
...
router.post('/user/ride_start', ApiController.startsRide);
router.post('/user/record_ride_payment', ApiController.recordRidePayments);
router.post('/user/withdraw_request', ApiController.requestWithdraw);
router.post('/user/pay_due', ApiController.payDue);
router.post('/user/duepaycreatePayment', ApiController.duepaycreatePayment);
router.post('/user/due_payment_history', ApiController.getDuePaymentHistory);
router.post('/user/payment_history', ApiController.getUserPaymentHistory);
...
router.post('/user/verify_otp', ApiController.verifyOtp);
router.post('/user/payment', ApiController.createPayment);
router.post('/user/callback', ApiController.ridePaymentCallback);
router.post('/user/driver_transaction_history', ApiController.getDriverTransactionHistory);
